...
def parse_args():
  ...
  parser = argparse.ArgumentParser(
      description='PyTorch Image Classification GPU')
...
def main():
  ...
  optimizer_ft = SGD(model_ft.parameters(), lr=args.learning_rate, momentum=args.momentum)
  ...
  local_model_path = os.path.join(local_model_dir, f'{model_name}')
